                ...
                <div class="card-body" style="padding: 25px;">
                    ...
                    <div style="margin-bottom: 20px; border-bottom: 3px solid #518ce5; padding-bottom: 10px;">
                        <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                            ...
                            @endif
                            <h5 style="margin: 0; font-weight: 800; color: #fff; display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                                {{ optional($user->rank)->name }}, {{ $user->name_private }}
                                @if(\Modules\LiveStream\Models\LiveStreamPilot::where('user_id', $user->id)->value('is_live'))
