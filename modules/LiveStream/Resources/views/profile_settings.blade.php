    ...
    <div class="ls-card">
      ...
      <div class="ls-card-body">
        ...
        <div class="obs-url-box">
          <p><i class="fas fa-info-circle me-1" style="color:#00c8ff;"></i> Adiciona este URL no OBS como <strong>Browser Source</strong> (1920×1080, fundo transparente):</p>
          <code>{{ url('/live/overlay/{pirep_id}') }}</code>
          <div class="ls-hint mt-2">Substitui <code>{pirep_id}</code> pelo ID do teu PIREP ativo quando estiveres a voar.</div>
        </div>
        @endif
